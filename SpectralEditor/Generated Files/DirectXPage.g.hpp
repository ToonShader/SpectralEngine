...
void ::SpectralEditor::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::SpectralEditor::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 4:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element4))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SpectralEditor::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SpectralEditor::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
